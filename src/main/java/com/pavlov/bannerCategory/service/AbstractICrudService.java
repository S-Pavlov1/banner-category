...
@Service
public abstract class AbstractICrudService<E extends DeletableObject> implements ICrudService<E> {
    ...
    public E getEntity(int id) throws NotFoundException {
        return repository.findById(id).orElseThrow(() -> new NotFoundException("Object not fond. Wrong id: " + id));
    }
